                ...
                <div class="prod_box_big">
                    ...
                    <div class="center_prod_box_big">
                        <div class="contact_form">
                            <div class="form_row">
             <!-- code cho form dang ky-->

                                <form action="register1.php" method="POST">
                                    <label class="contact"><i class="fas fa-users"></i><strong>&nbsp Họ và Tên:</strong></label>
                                    <input type="text" class="contact_input" name="fullname" id="fullname" />
                            </div>

                            <div class="form_row">
                                <label class="contact"><i class="fas fa-user-cog"></i><strong>&nbsp Tên đăng nhập:</strong></label>
                                <input type="text" class="contact_input" name="username" id="username" />
                            </div>

                            <div class="form_row">
                                <label class="contact"><i class="fas fa-key"></i><strong>&nbsp mật khẩu:</strong></label>
                                <input type="password" class="contact_input" id="pass" name="password" />
                            </div>

                            <div class="form_row">
                                <label class="contact"><strong><i class="fas fa-phone-square"></i> Số điện thoại:</strong></label>
                                <input type="text" class="contact_input" id="phonenumber"name="phonenumber" />
                            </div>
                            <div class="form_row">
                                <label class="contact"><strong><i class="fas fa-envelope"></i> Email:</strong></label>
                                <input type="email" class="contact_input" id="email" name="email" />
                            </div>
                            <div class="form_row">
                                <button type=""> 
                                        <i class="fas fa-check-circle"></i> 
                                        <input type="submit" value="Đăng Ký" name="create"></button>
